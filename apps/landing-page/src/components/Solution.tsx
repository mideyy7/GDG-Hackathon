const PILLARS = [
  ...
  },
  {
    ...
    body: 'DevClaw returns an architecture plan — affected files, agent assignments, risk flags — and waits for explicit approval. No AI writes a single line until you say go.',
    accent: false,
  },
];
